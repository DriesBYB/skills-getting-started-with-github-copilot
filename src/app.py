...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork, drills, and compete in soccer matches",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "natalie@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Improve shooting, defense, and game strategy on the court",
    ...
    "Art Workshop": {
        ...
        "max_participants": 10,
        "participants": ["luna@mergington.edu", "zoe@mergington.edu"]
    },
    "Math Olympiad": {
